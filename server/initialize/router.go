...
func Routers() *gin.Engine {
	...
	config.AllowOrigins = []string{"https://winh5.kejiwuya.com"} // 设置允许的源
	config.AllowHeaders = []string{"*"}                          // 设置允许的请求头字段
	...
	}
	{
		...
		usersRouter.InitUsersRouter(PrivateGroup)
	}
	{
		article_categoryRouter := router.RouterGroupApp.Article_category
		article_categoryRouter.InitArticleCategoryRouter(PrivateGroup)
	}
	{
	...
	}
	{
		...
		rechargeRouter.InitRechargeRouter(PrivateGroup)
	}
	{
