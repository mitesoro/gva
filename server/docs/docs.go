...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apis.ReqLogin"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "{\"code\":0,\"data\":{\"access_token\":\"ZWdUJTJCUGliYWNZQ0NGVUwzQUtUbFZwd3ZlR3FDWURGMFFlZUdMWFJaQzdMY3BWbGxiUnR6VjJOc0JYVmRBMEpsdlJCayUyQjVLWHUxNHRLVXUwekZ5dE5nJTNEJTNE\"},\"msg\":\"查询成功\"}",
                        "schema": {
                            "type": "string"
                        }
                    }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apis.ReqOrders"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apis.ReqRegister"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apis.ReqUpdateUser"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apis.ReqUpdatePassword"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/apis.ReqUpdatePhone"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/recharge.Recharge"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/symbols.Symbol"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "apis.SymbolData": {
            ...
            "properties": {
                "ask_price": {
                    "description": "卖出价。为零代表无卖出价。",
                    "type": "number"
                },
                "ask_volume": {
                    "description": "卖出量。为零代表无卖出价。",
                    "type": "integer"
                },
                "average_price": {
                    "description": "市场均价",
                ...
                "bid_price": {
                    "description": "买入价。为零代表无买入价。",
                    "type": "number"
                },
                "bid_volume": {
                    "description": "买入量。为零代表无买入价。",
                    "type": "integer"
                },
                "createdAt": {
                    "description": "创建时间",
