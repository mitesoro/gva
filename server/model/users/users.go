...
type Users struct {
	...
	AvailableAmount int    `json:"available_amount" form:"available_amount" gorm:"column:available_amount;comment:可用金额;"`
	FreezeAmount    int    `json:"freeze_amount" form:"freeze_amount" gorm:"column:freeze_amount;comment:冻结金额;"`
}
