      ...
      <el-scrollbar height="500px">
          <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
            ...
            <el-form-item label="开始时间:"  prop="start_at" >
              <el-time-select v-model="formData.start_at" start="06:30" step="00:15" end="20:30" placeholder="选择时间"></el-time-select>
            </el-form-item>
            <el-form-item label="结束时间:"  prop="end_at" >
              <el-time-select v-model="formData.end_at" start="06:30" step="00:15" end="20:30" placeholder="选择时间"></el-time-select>
            </el-form-item>
