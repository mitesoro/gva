<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="文章分类" prop="article_category" width="120">
            <template #default="scope">
      ...
      <el-scrollbar height="500px">
          <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
            ...
            <el-form-item label="文章分类:"  prop="article_category" >
              <el-select v-model="formData.article_category" placeholder="请选择文章分类" style="width:100%" :clearable="true" >
